...
Old Faithful is a geyser in Yellowstone National Park, and its eruption data is often used for statistical analysis and modeling in R. The dataset includes the durations of eruptions and the waiting time until the next eruption.
